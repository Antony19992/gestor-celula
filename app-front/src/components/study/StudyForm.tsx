  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="w-full resize-none rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      />
    </div>
  );
}
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="rounded-xl border border-dashed border-blue-200 bg-blue-50 p-4">
        <p className="mb-2 text-sm font-medium text-blue-800">Importar de PDF</p>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <label htmlFor="verse" className="mb-1.5 block text-sm font-medium text-gray-700">
            Versículo base <span className="text-red-500">*</span>
          </label>
          <input
            id="verse"
            type="text"
      ...
      <div className="border-t border-gray-100 pt-1">
        <p className="mb-4 text-xs font-semibold uppercase tracking-wider text-gray-400">Perguntas para discussão</p>
        <StringListField label="Perguntas" placeholder="Pergunta" items={questions} onChange={setQuestions} />
      </div>

      <div className="border-t border-gray-100 pt-1">
        <p className="mb-4 text-xs font-semibold uppercase tracking-wider text-gray-400">Aplicação</p>
      ...
      <div className="border-t border-gray-100 pt-1">
        <p className="mb-4 text-xs font-semibold uppercase tracking-wider text-gray-400">Oração</p>
