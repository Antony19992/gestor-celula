    ...
    <html lang="pt-BR">
      <body className={inter.className}>
        <div className="min-h-screen bg-gray-50">
          ...
          <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-gray-200 bg-white/90 backdrop-blur-sm sm:hidden">
            <div className="mx-auto flex max-w-2xl">

              <Link href="/" className="flex flex-1 flex-col items-center gap-0.5 py-3 text-gray-500 transition-colors hover:text-blue-600 active:text-blue-600">
              ...
              <Link href="/studies" className="flex flex-1 flex-col items-center gap-0.5 py-3 text-gray-500 transition-colors hover:text-blue-600 active:text-blue-600">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
              ...
              <Link href="/members" className="flex flex-1 flex-col items-center gap-0.5 py-3 text-gray-500 transition-colors hover:text-blue-600 active:text-blue-600">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
